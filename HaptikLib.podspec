...
Pod::Spec.new do |s|
  ...
  s.authors      = { 'Yogesh Singh' => 'yogesh@haptik.ai', 'Simranjot Singh' => 'simranjyot@haptik.ai' }
  ...
  s.frameworks =  'Accelerate', 'CoreGraphics', 'CoreLocation', 'CoreTelephony', 'CoreText', 'QuartzCore', 'SystemConfiguration', 'UIKit'
